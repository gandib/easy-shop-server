...
const paymentConfirmation = (transactionId) => __awaiter(void 0, void 0, void 0, function* () {
    const verifyResponse = yield (0, payment_utils_1.verifyPayment)(transactionId);
    let message = "";
    const trnxId = transactionId === null || transactionId === void 0 ? void 0 : transactionId.split("-easy-shop")[0];
    ...
    if (verifyResponse && verifyResponse.pay_status === "Successful") {
        const result = yield prisma_1.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
            const payment = yield transactionClient.payment.create({
                data: {
                    amount: orderData === null || orderData === void 0 ? void 0 : orderData.totalPrice,
                    transactionId,
                    orderId: trnxId,
                },
            });
